"""Add_null_date_chart_4_2

Revision ID: 0f3aacf77811
Revises: 478db6304fe2
Create Date: 2021-01-26 09:51:41.843828
...
revision = '0f3aacf77811'
down_revision = '478db6304fe2'
branch_labels = None
depends_on = None
...
# VOC 4_2:
CREATE
OR REPLACE VIEW `{project}.{datamart}.VOC_4_2_cusrevsstime` AS WITH table1 AS (
    SELECT
        case_study_id,
        max(case_study_name) case_study_name,
        max(dimension_config_name) dimension_config_name,
