"""update_view_voe_9_4_reviewsbycompany


Revision ID: 1ba6de256065
Revises: 355cc371913c
Create Date: 2021-05-25 09:34:26.247458
...
revision = '1ba6de256065'
down_revision = '355cc371913c'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    print("\n Update view VOE_9_4_reviewsbycompany is successfull!")
...
def downgrade():
    ...
    query_job .result()
    print("\n Downgrade 355cc371913c process is successfull!")
