"""change rule language_code = language_name if language_name is null in voc_1_4

Revision ID: 9095df2df9b4
Revises: b5ffcc35fea7
Create Date: 2021-02-18 14:08:53.869946
...
revision = '9095df2df9b4'
down_revision = '0534bb3684cb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Upgrade 9095df2df9b4 process is successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 9095df2df9b4 process is successfull!")
