"""create_voe_1_6_emprevtimesource_v

Revision ID: 40fb162e40df
Revises: fb81e9d939a7
Create Date: 2021-05-14 08:00:28.081091
...
revision = '40fb162e40df'
down_revision = 'fb81e9d939a7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Create view VOE_1_6_emprevtimesource_v successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade fb81e9d939a7 process is successfull!")
...
query_string2 = f"""
DROP VIEW  `{project}.{datamart}.VOE_1_6_emprevtimesource_v`;
"""
