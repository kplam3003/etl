"""remove parent review mappings VOC 1.1

Revision ID: bac046e81301
Revises: 3dce0c284350
Create Date: 2022-06-28 14:29:54.888165
...
revision = 'bac046e81301'
down_revision = '3dce0c284350'
branch_labels = None
depends_on = None
...
VOC_1_1_old = f"""
CREATE OR REPLACE VIEW `{project}.{datamart}.VOC_1_1_cusrevtimecompany_v` AS
...
def upgrade():
    query_job = bqclient.query(VOC_1_1_new)
    query_job .result()
    print(f"\nUpdate view VOC_1_1_cusrevtimecompany_v successful!")
    
def downgrade():
    query_job = bqclient.query(VOC_1_1_old)
    query_job .result()
