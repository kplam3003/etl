"""Add_null_date_chart_3

Revision ID: 67d00e796717
Revises: bb443dc4bb34
Create Date: 2021-01-26 09:50:33.948188
...
revision = '67d00e796717'
down_revision = 'bb443dc4bb34'
branch_labels = None
depends_on = None
...
# VOC 3:
CREATE
OR REPLACE VIEW `{project}.{datamart}.VOC_3_ratingtime` AS WITH date_case_study as (
    SELECT
        case_study_id,
...
# VOC 3:
CREATE
OR REPLACE VIEW `{project}.{datamart}.VOC_3_ratingtime` AS with table1 as (
    select
        case_study_id,
        max(case_study_name) case_study_name,
        max(dimension_config_name) dimension_config_name,
