"""update_view_voc_1_3_1

Revision ID: 55fa1079f6e9
Revises: 086a39255645
Create Date: 2021-07-15 12:23:22.179692
...
revision = '55fa1079f6e9'
down_revision = '086a39255645'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOC_1_3_1_cusrevcompany_p_v successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 086a39255645 process is successfull!")
