"""update_view_voc_1_3_2

Revision ID: 341ee11e822a
Revises: 55fa1079f6e9
Create Date: 2021-07-15 12:23:28.767784
...
revision = '341ee11e822a'
down_revision = '55fa1079f6e9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOC_1_3_2_cusrevcompany_b_v successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 55fa1079f6e9 process is successfull!")
