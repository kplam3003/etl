"""change sources of voc_1_3_2

Revision ID: d31c63d8018e
Revises: 9166eb0ed220
Create Date: 2021-01-29 10:31:44.949417
...
revision = 'd31c63d8018e'
down_revision = '9166eb0ed220'
branch_labels = None
depends_on = None
...
query_string1 = f"""
CREATE OR REPLACE VIEW  `{project}.{datamart}.VOC_1_3_2_cusrevcompany_b_v` 
AS
SELECT 
case_study_id,
