"""Add_null_date_chart_1_6

Revision ID: bb443dc4bb34
Revises: b605f007aa43
Create Date: 2021-01-26 09:49:51.085469
...
revision = 'bb443dc4bb34'
down_revision = 'b605f007aa43'
branch_labels = None
depends_on = None
...
# VOC 1_6:
CREATE
OR REPLACE VIEW `{project}.{datamart}.VOC_1_6_cusrevtimesource_v` AS WITH date_case_study as (
    SELECT
        case_study_id,
    ...
    WHERE
        dimension_config_name is not null # and case_study_id = 144
    GROUP BY
        case_study_id,
        dimension_config_id,
        nlp_type,
...
# VOC 1_6:
CREATE
OR REPLACE VIEW `{project}.{datamart}.VOC_1_6_cusrevtimesource_v` AS WITH table1 AS (
    SELECT
        case_study_id,
        case_study_name,
        max(dimension_config_name) dimension_config_name,
