"""remove parent review mappings VOE 1_4

Revision ID: c784e8f3616b
Revises: 6c27464a250a
Create Date: 2022-06-28 16:25:32.112482
...
revision = 'c784e8f3616b'
down_revision = '6c27464a250a'
branch_labels = None
depends_on = None
...
def upgrade():
    query_job = bqclient.query(VOE_1_4_new)
    query_job .result()
    print(f"\nUpdate view VOE_1_4_emprevtimelangue_v successful!")
    
def downgrade():
    query_job = bqclient.query(VOE_1_4_old)
    query_job .result()
