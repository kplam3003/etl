"""change_logic_count_job_voe_8_1_roleseniorquant

Revision ID: 68d153cafb56
Revises: a452269e435a
Create Date: 2021-12-01 14:50:48.513086
...
revision = '68d153cafb56'
down_revision = 'a452269e435a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Upgrade logic view VOE_8_1_roleseniorquant successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade logic view VOE_8_1_roleseniorquant successfull!")

query_string1 = f"""
CREATE
OR REPLACE VIEW `{project}.{datamart}.VOE_8_1_roleseniorquant` AS
