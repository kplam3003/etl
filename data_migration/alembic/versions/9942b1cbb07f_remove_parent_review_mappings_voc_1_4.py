"""remove parent review mappings VOC 1.4

Revision ID: 9942b1cbb07f
Revises: 70d2b406c4d2
Create Date: 2022-06-28 14:39:08.104193
...
revision = '9942b1cbb07f'
down_revision = '70d2b406c4d2'
branch_labels = None
depends_on = None
...
def upgrade():
    query_job = bqclient.query(VOC_1_4_new)
    query_job.result()
    print(f"\nUpdate view VOC_1_4_cusrevtimelangue_v successful!")
    
def downgrade():
    query_job = bqclient.query(VOC_1_4_old)
    query_job.result()
