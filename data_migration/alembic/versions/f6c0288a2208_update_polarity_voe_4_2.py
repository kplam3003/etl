"""update_polarity_voe_4_2

Revision ID: f6c0288a2208
Revises: 56d7ed94f38e
Create Date: 2021-08-02 10:06:45.618445
...
revision = 'f6c0288a2208'
down_revision = '56d7ed94f38e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOE_4_2_emprevsstime successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 56d7ed94f38e process is successfull!")


query_string1 = f"""
CREATE OR REPLACE VIEW `{project}.{datamart}.VOE_4_2_emprevsstime` AS 
