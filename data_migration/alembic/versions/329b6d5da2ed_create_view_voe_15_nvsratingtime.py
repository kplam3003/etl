"""create_view_voe_15_nvsratingtime

Revision ID: 329b6d5da2ed
Revises: 0f43ce2818fd
Create Date: 2021-06-25 03:37:09.821814
...
revision = '329b6d5da2ed'
down_revision = '0f43ce2818fd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Create view VOE_15_nvsratingtime successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 0f43ce2818fd process is successfull!")

query_string1 = f"""
CREATE OR REPLACE VIEW `{project}.{datamart}.VOE_15_nvsratingtime` AS 
...
query_string2 = f"""
DROP VIEW  `{project}.{datamart}.VOE_15_nvsratingtime`;
"""