"""fix bug missing partition source_id in voc_6_6

Revision ID: 76de71bdfd61
Revises: b5ffcc35fea7
Create Date: 2021-02-18 07:40:54.773051
...
revision = '76de71bdfd61'
down_revision = 'dffcb53e3baa'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Upgrade 76de71bdfd61 process is successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 76de71bdfd61 process is successfull!")
