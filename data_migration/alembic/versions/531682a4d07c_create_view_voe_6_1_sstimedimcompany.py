"""create_view_voe_6_1_sstimedimcompany

Revision ID: 531682a4d07c
Revises: 0e0d92c8888a
Create Date: 2021-05-17 06:28:05.089804
...
revision = '531682a4d07c'
down_revision = '0e0d92c8888a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Create view VOE_6_1_sstimedimcompany successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 0e0d92c8888a process is successfull!")
...
query_string2 = f"""
DROP VIEW  `{project}.{datamart}.VOE_6_1_sstimedimcompany`;
"""