...
Revision ID: a9de20c13085
Revises: a83b4e36784d
Create Date: 2021-07-19 07:47:09.833723
...
revision = 'a9de20c13085'
down_revision = 'a83b4e36784d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOE_14_nvsrating successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade a83b4e36784d process is successfull!")
