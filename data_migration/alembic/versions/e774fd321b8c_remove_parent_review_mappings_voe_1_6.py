"""remove parent review mappings VOE 1_6

Revision ID: e774fd321b8c
Revises: 7c48ec6186b3
Create Date: 2022-06-28 16:30:21.328484
...
revision = 'e774fd321b8c'
down_revision = '7c48ec6186b3'
branch_labels = None
depends_on = None
...
def upgrade():
    query_job = bqclient.query(VOE_1_6_new)
    query_job .result()
    print(f"\nUpdate view VOE_1_6_emprevtimesource_v successful!")
    
def downgrade():
    query_job = bqclient.query(VOE_1_6_old)
    query_job .result()
