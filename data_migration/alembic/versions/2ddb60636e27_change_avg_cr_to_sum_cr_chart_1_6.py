"""change avg CR to sum CR - chart 1_6

Revision ID: 2ddb60636e27
Revises: a5af022ffeeb
Create Date: 2021-03-02 06:23:12.145122
...
revision = '2ddb60636e27'
down_revision = 'a5af022ffeeb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Upgrade 2ddb60636e27 process is successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 2ddb60636e27 process is successfull!")
