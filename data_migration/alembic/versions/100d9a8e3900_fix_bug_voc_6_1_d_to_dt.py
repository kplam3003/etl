"""fix bug voc_6_1_d_to_dt

Revision ID: 100d9a8e3900
Revises: d28e07410254
Create Date: 2021-02-04 06:33:12.252509
...
revision = '100d9a8e3900'
down_revision = 'd28e07410254'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Upgrade 100d9a8e3900 process is successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 100d9a8e3900 process is successfull!")
