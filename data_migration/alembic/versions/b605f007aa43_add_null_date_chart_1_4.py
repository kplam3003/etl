"""Add_null_date_chart_1_4

Revision ID: b605f007aa43
Revises: 42bc31af3067
Create Date: 2021-01-26 09:46:37.547699
...
revision = 'b605f007aa43'
down_revision = '42bc31af3067'
branch_labels = None
depends_on = None
...
# VOC 1_4:
CREATE
OR REPLACE VIEW `{project}.{datamart}.VOC_1_4_cusrevtimelangue_v` AS WITH date_case_study as (
    SELECT
        case_study_id,
...
date_company as (
    SELECT
        ...
        CASE
            ...
            or language_code = '' THEN 'others'
            ELSE language
        END as language_name,
        CASE
            WHEN language = 'others'
            or language_code is null
            or language_code = '' THEN 'others'
            ELSE language_code
...
# VOC 1_4:
CREATE
OR REPLACE VIEW `{project}.{datamart}.VOC_1_4_cusrevtimelangue_v` AS WITH table1 AS (
    SELECT
        case_study_id,
        case_study_name,
        max(dimension_config_name) dimension_config_name,
