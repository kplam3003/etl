"""update_view_voe_nlp_output

Revision ID: 08d95b9231de
Revises: 4f1138aa662e
Create Date: 2021-07-15 04:44:38.996592
...
revision = '08d95b9231de'
down_revision = '4f1138aa662e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    print("\n Update view voe_nlp_output on Datamart successfull!")
...
def downgrade():
    ...
    query_job .result()
    print("\n Downgrade 4f1138aa662e process is successfull!")
