"""update_view_voe_6_3_dimpolarity

Revision ID: 0c06f2c01f04
Revises: 6b1c6ad5cccd
Create Date: 2021-08-27 10:00:02.812156
...
revision = '0c06f2c01f04'
down_revision = '6b1c6ad5cccd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOE_6_3_dimpolarity successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 6b1c6ad5cccd process is successfull!")
