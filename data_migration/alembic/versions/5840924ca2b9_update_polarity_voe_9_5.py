"""update_polarity_voe_9_5

Revision ID: 5840924ca2b9
Revises: c4b09630cd09
Create Date: 2021-08-02 10:07:35.128143
...
revision = '5840924ca2b9'
down_revision = 'c4b09630cd09'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOE_9_5_ssbytimecompany successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade c4b09630cd09 process is successfull!")
