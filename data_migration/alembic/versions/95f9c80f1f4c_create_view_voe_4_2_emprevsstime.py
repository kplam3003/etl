"""create_view_voe_4_2_emprevsstime

Revision ID: 95f9c80f1f4c
Revises: c48fcadac956
Create Date: 2021-05-13 07:24:35.510660
...
revision = '95f9c80f1f4c'
down_revision = 'c48fcadac956'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Create view VOE_4_2_emprevsstime successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade c48fcadac956 process is successfull!")
...
query_string2 = f"""
DROP VIEW  `{project}.{datamart}.VOE_4_2_emprevsstime`;
"""