"""change avg CR to sum CR - chart 1_4

Revision ID: a5af022ffeeb
Revises: 096ae98c008f
Create Date: 2021-03-02 06:14:42.325712
...
revision = 'a5af022ffeeb'
down_revision = '096ae98c008f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Upgrade a5af022ffeeb process is successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade a5af022ffeeb process is successfull!")
