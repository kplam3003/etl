"""update_view_voe_1_4_emprevtimelangue_v

Revision ID: 4d77fced50a7
Revises: 049e16a38d09
Create Date: 2021-05-25 03:08:18.192359
...
revision = '4d77fced50a7'
down_revision = '049e16a38d09'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOE_1_4_emprevtimelangue_v successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 049e16a38d09 process is successfull!")
