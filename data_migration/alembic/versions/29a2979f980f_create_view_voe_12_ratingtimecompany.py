"""Create view VOE_12_ratingtimecompany

Revision ID: 29a2979f980f
Revises: 49a5600dde64
Create Date: 2022-07-04 14:35:20.253532
...
revision = '29a2979f980f'
down_revision = '49a5600dde64'
branch_labels = None
depends_on = None
...
VOE_12 = f"""
CREATE OR REPLACE VIEW `{project}.{datamart}.VOE_12_ratingtimecompany` AS
...
def upgrade():
    query_job =bqclient.query(VOE_12)
    query_job.result()
    print("\n Create view VOE_12_ratingtimecompany successfull!")

drop_view = f"""
    DROP VIEW  `{project}.{datamart}.VOE_12_ratingtimecompany`;
"""

def downgrade():
    query_job =bqclient.query(drop_view)
    query_job .result()
