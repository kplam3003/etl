...
Revision ID: 572a294d0ba1
Revises: 08d95b9231de
Create Date: 2021-07-15 12:22:33.455197
...
revision = '572a294d0ba1'
down_revision = '08d95b9231de'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOC_1_1_cusrevtimecompany_v is successfull!")
...
def downgrade():
    ...
    query_job .result()
    print("\n Downgrade 08d95b9231de process is successfull!")
