"""fix bug voc_6_6_d_to_dt

Revision ID: 32da9e5da223
Revises: 100d9a8e3900
Create Date: 2021-02-04 06:41:02.682374
...
revision = '32da9e5da223'
down_revision = '100d9a8e3900'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Upgrade 32da9e5da223 process is successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 32da9e5da223 process is successfull!")
