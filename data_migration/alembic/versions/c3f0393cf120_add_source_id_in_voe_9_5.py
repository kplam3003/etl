"""add_source_id_in_voe_9_5

Revision ID: c3f0393cf120
Revises: 59d4bd968f56
Create Date: 2021-05-05 07:01:05.584696
...
revision = 'c3f0393cf120'
down_revision = '59d4bd968f56'
branch_labels = None
depends_on = None
...
def upgrade():
    """ Update view VOE_9_5_ssbytimecompany"""
    query_job =bqclient.query(query_string1)
    query_job .result()
  
    print("\n Update VOE_9_5_ssbytimecompany is successfull!")
...
def downgrade():
    ...
    query_job .result()
    print("\n Downgrade 59d4bd968f56 process is successfull!")
