"""update_polarity_voe_6_6

Revision ID: c4b09630cd09
Revises: 8c7631c2d403
Create Date: 2021-08-02 10:07:27.648929
...
revision = 'c4b09630cd09'
down_revision = '8c7631c2d403'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOE_6_6_sstimesourcecompany successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 8c7631c2d403 process is successfull!")
