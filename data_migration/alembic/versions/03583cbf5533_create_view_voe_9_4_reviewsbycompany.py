"""create_view_voe_9_4_reviewsbycompany

Revision ID: 03583cbf5533
Revises: 3cb325c69926
Create Date: 2021-05-05 04:49:41.821179
...
revision = '03583cbf5533'
down_revision = '3cb325c69926'
branch_labels = None
depends_on = None
...
def upgrade():
    """ Create view VOE_9_4_reviewsbycompany"""
    query_job =bqclient.query(query_string1)
    query_job .result()
  
    print("\n Create view VOE_9_4_reviewsbycompany is successfull!")
...
def downgrade():
    ...
    query_job .result()
    print("\n Downgrade 3cb325c69926 process is successfull!")
...
"""
query_string2 = f"""
DROP VIEW `{project}.{datamart}.VOE_9_4_reviewsbycompany` ;
