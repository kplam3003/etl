"""remove parent review mappings VOC 1.5

Revision ID: 4183699d73da
Revises: ab07f230cbf8
Create Date: 2022-06-28 14:47:07.253249
...
revision = '4183699d73da'
down_revision = 'ab07f230cbf8'
branch_labels = None
depends_on = None
...
def upgrade():
    query_job = bqclient.query(VOC_1_5_new)
    query_job .result()
    print(f"\nUpdate view VOC_1_5_cusrevlangue_p_v successful!")
    
def downgrade():
    query_job = bqclient.query(VOC_1_5_old)
    query_job .result()
