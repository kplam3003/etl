...
Revision ID: c055804cf639
Revises: 6d19badc1a28
Create Date: 2021-01-27 07:05:15.988209
...
revision = 'c055804cf639'
down_revision = '6d19badc1a28'
branch_labels = None
depends_on = None
...
single2 AS (
    SELECT
        ...
        count(
            case
                when polarity != 'NONE' then review_id
                else null
            end
        ) as sum_review_counts,
