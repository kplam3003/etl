"""remove parent review mappings VOC 1.4.1

Revision ID: ab07f230cbf8
Revises: 9942b1cbb07f
Create Date: 2022-06-28 14:42:33.762117
...
revision = 'ab07f230cbf8'
down_revision = '9942b1cbb07f'
branch_labels = None
depends_on = None
...
def upgrade():
    query_job = bqclient.query(VOC_1_4_1_new)
    query_job .result()
    print(f"\nUpdate view VOC_1_4_1_cusrevtimecountry_v successful!")
    
def downgrade():
    query_job = bqclient.query(VOC_1_4_1_old)
    query_job .result()
