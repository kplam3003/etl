"""update_etl_lead_time_dedup_view_name

Revision ID: f5904b62d051
Revises: f3dbd03f74a6
Create Date: 2021-03-19 03:45:09.378128
...
revision = 'f5904b62d051'
down_revision = 'f3dbd03f74a6'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\nDrop view elt_lead_time_monitor_dedup in Data Quality successfull!")
    time.sleep(15)
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\nCreating new view etl_lead_time_monitor_dedup in Data Quality successfull!")
...
def downgrade():
    ...
    query_job .result()
    print("\n Downgrade f3dbd03f74a6 process is successfull!")
