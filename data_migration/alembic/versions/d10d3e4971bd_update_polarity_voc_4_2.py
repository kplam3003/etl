"""update_polarity_voc_4_2

Revision ID: d10d3e4971bd
Revises: 50e32c048fcf
Create Date: 2021-08-02 09:06:21.050252
...
revision = 'd10d3e4971bd'
down_revision = '50e32c048fcf'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOC_4_2_cusrevsstime successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 50e32c048fcf process is successfull!")
