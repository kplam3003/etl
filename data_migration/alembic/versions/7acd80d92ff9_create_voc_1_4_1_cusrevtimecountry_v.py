"""create_VOC_1_4_1_cusrevtimecountry_v

Revision ID: 7acd80d92ff9
Revises: 9b18e151ca38
Create Date: 2021-10-25 04:58:34.892674
...
revision = '7acd80d92ff9'
down_revision = '9b18e151ca38'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Create view VOC_1_4_1_cusrevtimecountry_v successfull!")
...
query_string2 = f"""
DROP VIEW  `{project}.{datamart}.VOC_1_4_1_cusrevtimecountry_v`;
"""
