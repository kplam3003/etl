"""remove parent review mappings VOC 14

Revision ID: 3dce0c284350
Revises: a3d8a27e9c0a
Create Date: 2022-06-28 14:25:58.016951
...
revision = '3dce0c284350'
down_revision = 'a3d8a27e9c0a'
branch_labels = None
depends_on = None
...
def upgrade():
    query_job = bqclient.query(VOC_14_new)
    query_job .result()
    print(f"\nUpdate view VOC_14_nvsrating successful!")
    
def downgrade():
    query_job = bqclient.query(VOC_14_old)
    query_job .result()
