"""update_polarity_voc_6_1

Revision ID: 8740611d4c8e
Revises: d10d3e4971bd
Create Date: 2021-08-02 09:06:36.714398
...
revision = '8740611d4c8e'
down_revision = 'd10d3e4971bd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOC_6_1_sstimedimcompany successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade d10d3e4971bd process is successfull!")

query_string1 = f"""
CREATE OR REPLACE VIEW `{project}.{datamart}.VOC_6_1_sstimedimcompany` AS 
