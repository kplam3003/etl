...
Revision ID: 85716d348d33
Revises: b2381962c6bc
Create Date: 2021-07-19 07:46:51.978582
...
revision = '85716d348d33'
down_revision = 'b2381962c6bc'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOE_1_5_emprevlangue_p_v successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade b2381962c6bc process is successfull!")
