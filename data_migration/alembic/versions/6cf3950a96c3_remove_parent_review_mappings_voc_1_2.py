"""remove parent review mappings VOC 1.2

Revision ID: 6cf3950a96c3
Revises: bac046e81301
Create Date: 2022-06-28 14:32:52.793810
...
revision = '6cf3950a96c3'
down_revision = 'bac046e81301'
branch_labels = None
depends_on = None
...
def upgrade():
    query_job = bqclient.query(VOC_1_2_new)
    query_job .result()
    print(f"\nUpdate view VOC_1_2_cusrevstat_v successful!")
    
def downgrade():
    query_job = bqclient.query(VOC_1_2_old)
    query_job .result()
