"""change sources of voc_1_3_1

Revision ID: 9166eb0ed220
Revises: 73df2f66e0ae
Create Date: 2021-01-29 10:29:23.692153
...
revision = '9166eb0ed220'
down_revision = '73df2f66e0ae'
branch_labels = None
depends_on = None
...
CREATE OR REPLACE VIEW `{project}.{datamart}.VOC_1_3_1_cusrevcompany_p_v` 
AS
SELECT
    case_study_id,
