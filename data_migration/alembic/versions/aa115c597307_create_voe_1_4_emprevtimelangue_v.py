"""create_voe_1_4_emprevtimelangue_v

Revision ID: aa115c597307
Revises: 7ee725701d15
Create Date: 2021-05-14 07:50:52.972891
...
revision = 'aa115c597307'
down_revision = '7ee725701d15'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Create view VOE_1_4_emprevtimelangue_v successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 7ee725701d15 process is successfull!")
	
query_string1 = f"""
CREATE OR REPLACE VIEW `{project}.{datamart}.VOE_1_4_emprevtimelangue_v` AS 
...
query_string2 = f"""
DROP VIEW  `{project}.{datamart}.VOE_1_4_emprevtimelangue_v`;
"""
