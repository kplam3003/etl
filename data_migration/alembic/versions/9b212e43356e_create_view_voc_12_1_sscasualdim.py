"""create_view_voc_12_1_sscasualdim

Revision ID: 9b212e43356e
Revises: 7dc654e49a3e
Create Date: 2021-07-29 04:51:20.405828
...
revision = '9b212e43356e'
down_revision = '7dc654e49a3e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Create view VOC_12_1_sscasualdim successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 7dc654e49a3e process is successfull!")
