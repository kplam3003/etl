"""add is_used is not null to dimension_config_statistic

Revision ID: c905a09cb298
Revises: 5f5291583b51
Create Date: 2021-02-01 11:49:50.889169
...
revision = 'c905a09cb298'
down_revision = '5f5291583b51'
branch_labels = None
depends_on = None
...
CREATE
OR REPLACE VIEW `{project}.{datamart}.dimension_config_statistic` AS WITH run_id_t as (
    SELECT
        *,
        row_number() over (
