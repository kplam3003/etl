"""update_view_voe_1_3_2

Revision ID: 09e2aa1c339a
Revises: 01d648fbc316
Create Date: 2021-07-19 07:46:36.807233
...
revision = '09e2aa1c339a'
down_revision = '01d648fbc316'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOE_1_3_2_emprevcompany_b_v successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 01d648fbc316 process is successfull!")
