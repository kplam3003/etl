"""create_view_voc_14_nvsrating

Revision ID: 7fb0e5e9b9a5
Revises: 1eb424d7dadf
Create Date: 2021-06-25 03:35:44.975005
...
revision = '7fb0e5e9b9a5'
down_revision = '1eb424d7dadf'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Create view VOC_14_nvsrating successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 1eb424d7dadf process is successfull!")
	
query_string1 = f"""
CREATE OR REPLACE VIEW `{project}.{datamart}.VOC_14_nvsrating` AS 
...
query_string2 = f"""
DROP VIEW  `{project}.{datamart}.VOC_14_nvsrating`;
"""
