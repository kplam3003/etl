...
Revision ID: 5eafdfa3f80d
Revises: 6579a970306d
Create Date: 2021-07-15 12:24:26.474265
...
revision = '5eafdfa3f80d'
down_revision = '6579a970306d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOC_13_ratingtimecompany successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 6579a970306d process is successfull!")
