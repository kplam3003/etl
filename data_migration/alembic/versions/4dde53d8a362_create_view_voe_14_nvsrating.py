"""create_view_voe_14_nvsrating

Revision ID: 4dde53d8a362
Revises: 7fb0e5e9b9a5
Create Date: 2021-06-25 03:36:20.321561
...
revision = '4dde53d8a362'
down_revision = '7fb0e5e9b9a5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Create view VOE_14_nvsrating successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade 7fb0e5e9b9a5 process is successfull!")
	
query_string1 = f"""
CREATE OR REPLACE VIEW `{project}.{datamart}.VOE_14_nvsrating` AS 
...
query_string2 = f"""
DROP VIEW  `{project}.{datamart}.VOE_14_nvsrating`;
"""
