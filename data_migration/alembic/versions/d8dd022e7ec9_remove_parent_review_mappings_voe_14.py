"""remove parent review mappings VOE 14

Revision ID: d8dd022e7ec9
Revises: e998b9460a5d
Create Date: 2022-06-28 16:15:27.824758
...
revision = 'd8dd022e7ec9'
down_revision = 'e998b9460a5d'
branch_labels = None
depends_on = None
...
def upgrade():
    query_job = bqclient.query(VOE_14_new)
    query_job .result()
    print(f"\nUpdate view VOE_14_nvsrating successful!")
    
def downgrade():
    query_job = bqclient.query(VOE_14_old)
    query_job .result()
