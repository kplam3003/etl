"""update_view_voe_4_2_emprevsstime

Revision ID: 355cc371913c
Revises: d5a648903414
Create Date: 2021-05-25 03:09:22.646233
...
revision = '355cc371913c'
down_revision = 'd5a648903414'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    query_job .result()
    print("\n Downgrade d5a648903414 process is successfull!")
