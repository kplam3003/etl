"""update_polarity_voc_4_1

Revision ID: 50e32c048fcf
Revises: c5de88750fa8
Create Date: 2021-08-02 09:06:08.764665
...
revision = '50e32c048fcf'
down_revision = 'c5de88750fa8'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Update view VOC_4_1_sstimecompany successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade c5de88750fa8 process is successfull!")

query_string1 = f"""
CREATE OR REPLACE VIEW `{project}.{datamart}.VOC_4_1_sstimecompany` AS 
