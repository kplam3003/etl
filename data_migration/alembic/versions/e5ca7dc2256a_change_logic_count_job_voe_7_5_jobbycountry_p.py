"""change_logic_count_job_voe_7_5_jobbycountry_p

Revision ID: e5ca7dc2256a
Revises: 7b5ddf2c3750
Create Date: 2021-12-01 14:25:05.957675
...
revision = 'e5ca7dc2256a'
down_revision = '7b5ddf2c3750'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    query_job .result()
    print("\n Upgrade logic view VOE_7_5_jobbycountry_p successfull!")
    
def downgrade():
    query_job =bqclient.query(query_string2)
    query_job .result()
    print("\n Downgrade logic view VOE_7_5_jobbycountry_p successfull!")

query_string1 = f"""
CREATE
OR REPLACE VIEW `{project}.{datamart}.VOE_7_5_jobbycountry_p` AS
