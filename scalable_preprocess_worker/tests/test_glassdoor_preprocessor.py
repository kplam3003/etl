...
from app import transform_func_voe_review_glassdoor


# set up test case
class GlassdoorPreprocessorTest(unittest.TestCase):
    def setUp(self):
        self.payload = {"batch": {"source_name": "Glassdoor", "company_id": 2}}

        self.date = "2021-01-01"
        self.review_id = "abc123"
        self.rating = 5
    ...
    def _construct_test_result(self, review_dict):
        ...
        result = transform_func_voe_review_glassdoor(self.payload, test_item)
